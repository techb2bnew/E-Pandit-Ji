...
const MobileBannerBar = () => {
  return (
    <div className="block md:hidden">
      <div className={`grid grid-cols-4 gap-1 md:gap-3 max-w-7xl mx-auto max-w-[95%]  relative`}>
        {services.map((service) => (
          ...
          >
            ...
            <p className="mt-2 text-[10px]">{service.title}</p>
            {service.isComingSoon && (
              <span className="absolute -top-2 left-1/2 -translate-x-1/2 text-[9px] px-1.5 py-[2px] rounded bg-red-500 text-white animate-pulse whitespace-nowrap no-underline">
                Coming Soon
              </span>
            )}
          </Link>
