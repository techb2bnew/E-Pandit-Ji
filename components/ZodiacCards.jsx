...
export default function ZodiacSlider() {
  ...
  return (
    <div>
      ...
      <div>
        <div
          className=" flex items-center justify-center bg-black/80 px-4 backdrop-blur-sm"
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-3 px-5 pt-5">
              <div className="rounded-[18px] border border-[#ffd400]/30 bg-[#101010] p-4 text-center">
                <p className="text-[12px] text-white/60">Luck</p>
              ...
              <div className="rounded-[18px] border border-[#ffd400]/30 bg-[#101010] p-4 text-center">
                <p className="text-[12px] text-white/60">Health</p>
                <h3 className="mt-1 text-[24px] font-bold text-[#ffd400]">
                  8/10
                </h3>
              </div>
              ...
              <div className="rounded-[18px] border border-[#ffd400]/30 bg-[#101010] p-4 text-center">
                <p className="text-[12px] text-white/60">Career</p>
                <h3 className="mt-1 text-[24px] font-bold text-[#ffd400]">
                  6/10
                </h3>
              </div>
            ...
            <div className="space-y-4 px-5 pb-6 pt-5 grid grid-cols-2 gap-x-6 gap-y-4">
              {[
                {
                  title: "Personal Life",
                  rating: "7/10",
                ...
                <div
                  key={item.title}
                  className="rounded-[20px] border h-full border-[#ffd400]/25 bg-[#0f0f0f] p-4"
                >
                  <div className="mb-2 flex items-center justify-between gap-3">
                    <h3 className="text-[17px] font-semibold text-[#ffd400]">
                      {item.title}
                    </h3>
